...
#' @description \code{nmadt.hierarchical} performs meta-analysis using the hierarchical model \insertCite{Ma2018}{NMADiagT} and outputs CIs for accuracy measurements.
